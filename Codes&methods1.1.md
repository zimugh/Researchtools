...
### [Browser 2.0](http://sprg.ssl.berkeley.edu/%7Etohban/browser/?show=grth+qlpcr+qli02+qlids&bar=1)
- lightcurve
- image
- radio
...
2. /prate是画粒子监测曲线的，粒子影响也是非常重要的。光变上有很多峰是不起眼的粒子峰造成的。
...
（4）建议使用lgT下0.05的温度间隔，AIA图像最好合并一下像素，比如2*2合并一个，除非研究的结构太小。
